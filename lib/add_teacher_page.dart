...
import 'package:stamp/firebase_options.dart';
...
class _AddTeacherPageState extends State<AddTeacherPage> {
  ...
  Future<void> _initializeSecondaryApp() async {
    _secondaryApp = await Firebase.initializeApp(
      name: 'Secondary', // Any name you want
      options: DefaultFirebaseOptions.currentPlatform, // Same project!
    );
  }
  ...
  Future<void> _saveTeacher() async {
    ...
    setState(() {
      _isLoading = true;
      _errorMessage = null;
      subAdminId = FirebaseAuth.instance.currentUser?.uid;
    });
    ...
    try {
      ...
      // signout the newly created user
      FirebaseAuth.instanceFor(app: _secondaryApp!).signOut();
